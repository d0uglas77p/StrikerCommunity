...
@ManagedBean
@ViewScoped
public class VideoHeInfernoTRBean implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VideoHeInfernoTRBean.class.getName());
    ...
    public void init() {
        ...
        try {
            ...
            inputStream = context.getExternalContext().getResourceAsStream("/resources/properties/videos/terrorista/inferno/he.properties");
            if (inputStream != null) {
