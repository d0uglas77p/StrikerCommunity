...
@ManagedBean
@ViewScoped
public class VideoSmokeVertigoTRBean implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VideoSmokeVertigoTRBean.class.getName());
    ...
    public void init() {
        ...
        try {
            ...
            inputStream = context.getExternalContext().getResourceAsStream("/resources/properties/videos/terrorista/vertigo/smoke.properties");
            if (inputStream != null) {
