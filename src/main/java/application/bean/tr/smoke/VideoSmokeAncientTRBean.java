...
@ManagedBean
@ViewScoped
public class VideoSmokeAncientTRBean implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VideoSmokeAncientTRBean.class.getName());
    ...
    public void init() {
        ...
        try {
            ...
            inputStream = context.getExternalContext().getResourceAsStream("/resources/properties/videos/terrorista/ancient/smoke.properties");
            if (inputStream != null) {
