...
@ManagedBean
@ViewScoped
public class VideoMolotovOverpassTRBean implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VideoMolotovOverpassTRBean.class.getName());
    ...
    public void init() {
        ...
        try {
            ...
            inputStream = context.getExternalContext().getResourceAsStream("/resources/properties/videos/terrorista/overpass/molotov.properties");
            if (inputStream != null) {
