...
@ManagedBean
@ViewScoped
public class VideoMolotovAnubisTRBean implements Serializable {
    private static final long serialVersionUID = 1L;
    private static final Logger LOGGER = Logger.getLogger(VideoMolotovAnubisTRBean.class.getName());
    ...
    public void init() {
        ...
        try {
            ...
            inputStream = context.getExternalContext().getResourceAsStream("/resources/properties/videos/terrorista/anubis/molotov.properties");
            if (inputStream != null) {
